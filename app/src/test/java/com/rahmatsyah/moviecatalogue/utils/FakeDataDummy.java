...
public class FakeDataDummy {
    ...
    public static ArrayList<MovieResponse> generateRemoteDummyMovie(){
        ...
        movieResponses.add(new MovieResponse(
                ...
                "/kTca5fpKhFOKIiG0tz8tynhsWs5.jpg"
        ));
        ...
        movieResponses.add(new MovieResponse(
                ...
                "/9Z2qT9iZYLzzsCSYu7A4SEQsKX0.jpg"
        ));
        ...
        movieResponses.add(new MovieResponse(
                ...
                "/4tS0iyKQBDFqVpVcH21MSJwXZdq.jpg"
        ));
    ...
    public static ArrayList<TvShowResponse> generateRemoteDummyTvShow(){
        ...
        tvShowResponses.add(new TvShowResponse(
                ...
                "/nel144y4dIOdFFid6twN5mAX9Yd.jpg"
        ));
        tvShowResponses.add(new TvShowResponse(
                1416,
                6.3,
        ...
        tvShowResponses.add(new TvShowResponse(
                ...
                "/nUsdcwmoYP4DiZtJcAWkpxjRnay.jpg"
        ...
        tvShowResponses.add(new TvShowResponse(
                ...
                "/gxTojpKEOtue85EEFlozwRbDXwJ.jpg"
        ));
        tvShowResponses.add(new TvShowResponse(
                60574,
                8.3,
        ...
        tvShowResponses.add(new TvShowResponse(
                ...
                "/3iFm6Kz7iYoFaEcj4fLyZHAmTQA.jpg"
        ));
        tvShowResponses.add(new TvShowResponse(
                66732,
                8.3,
        ...
        tvShowResponses.add(new TvShowResponse(
                ...
                "/u6MpSEaUlDEv7KCn49aHhtTQ43L.jpg"
        ));
        tvShowResponses.add(new TvShowResponse(
                60708,
                6.9,
        ...
        tvShowResponses.add(new TvShowResponse(
                ...
                "/vT0Zsbm4GWd7llNjgWEtwY0CqOv.jpg"
        ));
        tvShowResponses.add(new TvShowResponse(
                76479,
                8.2,
